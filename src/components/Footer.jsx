const Footer = () => {
  return (
    <footer className="p-10 pb-10 bg-cyan-300 space-y-5">
      <div className="flex justify-center">
        <h2 className="text-center font-extrabold text-3xl opacity-70">
          sunnyside
        </h2>
      </div>
      <div>
        <ul className="flex justify-center space-x-20 opacity-50 ">
          <li>About</li>
          <li>Services</li>
          <li>Projects</li>
        </ul>
